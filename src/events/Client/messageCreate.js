    ...
    run: async (client, message) => {
        ...
        if (message.content.match(mention)) {
            const embed = new EmbedBuilder()
                ...
                .addFields([
                    {
                        name: "**__Thanks For Pinging__**",
                        value: `<a:x_dot:1247589958600888332> Browse my commands by using \`${prefix}help\`
<a:x_dot:1247589958600888332> Join [Community](https://discord.gg/codersplanet) to get updates related to Axocoder.`,
                        inline: true,
                    },
                ]);
            ...
            const row = new ActionRowBuilder().addComponents(
                ...
                new ButtonBuilder()
                    ...
                    .setURL("https://discord.gg/ekdbQvuhza"),
            );
                ...
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `<@${message.author.id}> You are Not Premium User`,
                            ),
                    ],
                });
            }
