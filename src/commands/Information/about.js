...
module.exports = {
    ...
    execute: async (message, args, client, prefix) => {
        ...
        const mainPage = new EmbedBuilder()
            ...
            .setDescription(
                `I'm a discord Multipurpose bot with some awesome features that's gonna explode your mind.
...
Do you wanna make your server more active and chill with some cool bot!`,
            ...
            .addFields([
                {
                    name: "**__Developers__**",
                    value: "**[thelasthonnoredones](https://discord.com/users/842480950202073149)**",
                    inline: true,
                },
